      ...
      >
        ...
        <div className="d-desc">
          <div className="d-qrcode">
            <QRCode
              value={`http:${serverAddress}/page/preview?pageId=${pageId}`}
            />
          </div>
          <p>预览页有效期30分钟，发布后永久生效</p>
          <h2>{pageName}</h2>
        </div>
        <div className="d-close-btn J_closeBtn" onClick={this.closePreview}>
          <Icon type="close" />
        </div>
        ...
        <div className="d-right">
          {hasPreview && (
            <React.Fragment>
              ...
              <div className="J_preview d-preview" onClick={this.preview}>
                预览
              </div>
            </React.Fragment>
          )}
          {hasPublish && (
            <React.Fragment>
              <div className="d-line" />
              <div className="J_publish d-publish" onClick={this.publish}>
                发布
              </div>
            </React.Fragment>
          )}
