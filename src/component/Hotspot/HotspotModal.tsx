...
> {
  ...
  handleEndDraw = () => {
    ...
    const hotspots: HotspotInfo[] = areas
      .map((v, i) => {
        let result: any;
  ...
  renderImgs = (imgs: ImageInfo[]) => {
    ...
    return <React.Fragment>{imgs.map(renderImg)}</React.Fragment>;
  };
  ...
  renderHotspots = (hotspots: HotspotInfo[]) => {
    ...
    return <React.Fragment>{hotspots.map(renderItem)}</React.Fragment>;
  };
  ...
  renderAreas = (areas: AreaInfo[]) => {
    ...
    return <React.Fragment>{areas.map(renderArea)}</React.Fragment>;
  };
    ...
    return (
      ...
      >
        <div className="d-content">
          <div className="d-imgs-container" draggable={false}>
            <div
