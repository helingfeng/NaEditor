  ...
  render() {
    ...
    const horizontalBefore = (
      <Select
        ...
        onChange={(horizontalDir: any) => {
          this.setState({ horizontalDir });
        }}
        style={{ width: 90 }}
      >
    ...
    const verticalBefore = (
      <Select
        ...
        onChange={(verticalDir: any) => {
          this.setState({ verticalDir });
        }}
        style={{ width: 90 }}
      >
    ...
    const horizontalAfter = (
      <Select
        ...
        onChange={(horizontalUnit: any) => {
          this.setState({ horizontalUnit });
        }}
        style={{ width: 50 }}
      >
    ...
    const verticalAfter = (
      <Select
        ...
        onChange={(verticalUnit: any) => {
          this.setState({ verticalUnit });
        }}
        style={{ width: 50 }}
      >
        <Option value={Unit.percent}>%</Option>
