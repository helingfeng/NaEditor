...
class TemplateLibModal extends React.Component<
  TemplateLibModalProps,
  TemplateLibModalState
> {
          ...
          <div
            ...
            style={{
              backgroundImage: `url(${
                v.imgUrl
                  ? v.imgUrl
                  : '//timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1539512672741&di=330c4174f3e7254e271baea3f49217c8&imgtype=0&src=http%3A%2F%2Fpic.58pic.com%2F58pic%2F15%2F41%2F24%2F82G58PICnZi_1024.png'
              })`,
            }}
          />
          <p className="d-template-name" title={v.name}>
            {v.name}
          </p>
