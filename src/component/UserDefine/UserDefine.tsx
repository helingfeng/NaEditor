...
> {
  ...
  shouldComponentUpdate(
    nextProps: UserDefineProps,
    nextState: UserDefineState,
  ) {
    if (this.context.BASE_DATA.pageType === 0) {
      const isActive =
        nextProps.moduleData.tempData && nextProps.moduleData.tempData.isActive;
      if (
        this.state.code === nextProps.moduleData.data.code &&
